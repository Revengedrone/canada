...
export const Route = createFileRoute("/_authenticated/dashboard")({
  ...
  head: () => ({
    meta: [
      { title: "Dashboard — The Bank of Nova Scotia" },
...
function Logo() {
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-base font-extrabold tracking-tight text-[#D71E28] sm:text-xl">The Bank of Nova Scotia</span>
    </div>
  );
}
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <footer className="border-t border-slate-100 bg-white">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-x-4 gap-y-2 px-4 py-4 text-xs text-slate-500 sm:px-6">
          ...
          <span>© 2026 The Bank of Nova Scotia. All rights reserved.</span>
          <span className="hidden sm:inline">|</span>
